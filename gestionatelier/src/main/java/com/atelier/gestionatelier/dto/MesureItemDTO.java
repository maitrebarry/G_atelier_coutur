...
public class MesureItemDTO {
    ...
    public void setHomme_tour_manche(String homme_tour_manche) {
        this.homme_tour_manche = homme_tour_manche;
    }
    ...
    public int getHabitPhotoIndex() {
        return habitPhotoIndex;
    }
