...
import {createRendezvous, listClientsForRendezvous} from '../services/rendezvousService';
...
export default function RendezvousFormScreen({route, navigation}) {
  ...
  const save = async () => {
    ...
    try {
      ...
      Alert.alert('Erreur', error?.message || 'Creation impossible');
    }
  };
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <AppButton label="Creer" onPress={save} />
    </ScrollView>
  );
}
